...
import TrainmentReports from './components/TrainmentReports';
import ValuationReports from './components/ValuationReports';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path={APP_ROUTES.USER_REPORTS} element={<UserReports />} />
        <Route path={APP_ROUTES.TRAINMENT_REPORTS} element={<TrainmentReports />} />
        <Route path={APP_ROUTES.VALUATION_REPORTS} element={<ValuationReports />} />
