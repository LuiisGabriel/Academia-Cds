...
const PostValuation = () => {
    ...
    const { score, totalQuestions, isSubmitted, results } = location.state || { score: 0, totalQuestions: 0, isSubmitted: false, results: [] };
            ...
            <div className="bg-gray-300 h-auto min-h-screen">
                ...
                <div className="flex items-center justify-center py-16">
                    ...
                    <div className="bg-white rounded-lg  w-3/4 flex flex-col items-center justify-center py-8 select-none">
                        ...
                        <button
                            className="text-sm bg-gray-800 rounded-lg p-2 mt-8 text-white hover:scale-102 hover:bg-gray-700 transition-all duration-300 ease-in-out"
                            onClick={() => {
                                navigate(APP_ROUTES.VALUATIONS);
                            }}
                        >
