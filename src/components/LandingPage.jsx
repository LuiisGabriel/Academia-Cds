...
const LandingPage = () => {
  ...
  const listenScrollEvent = () => {
    window.scrollY > 370 ? setnavColor("#002B4E") : setnavColor("transparent");
      ...
      <div className='flex items-center justify-center select-none'>
        ...
        <div className='z-1 w-full pt-50 pointer-events-none'>
          ...
          <div className='h-100 w-full py-16 bg-gray-300 flex justify-end pointer-events-auto'>
            ...
            <div className='rounded-l-[10vw] bg-cdsBlue transition-all duration-300 ease-in-out w-2/4 hover:w-3/5 h-full flex flex-col items-center justify-center shadow-lg/30'>
          ...
          <div className='h-100 bg-gray-300 py-16 flex pointer-events-auto'>
            ...
            <div className='rounded-r-[10vw] bg-cdsBlue transition-all duration-300 ease-in-out w-2/4  hover:w-3/5 h-full flex flex-col items-center justify-center shadow-lg/30'>
              ...
              {imagens.map((imagem) => (
                ...
                >
                  ...
                  <div className='py-6'>
                    <a
                      href={imagem.href1}
                      className='px-4 py-2 bg-cdsBlue rounded-full text-gray-300 items-center justify-center flex text-md hover:scale-102 shadow-sm/40 transition-all duration-150 ease-in-out '>
                      Saiba mais
                    </a>
                  </div>
                </div>
          ...
          <div className='bg-cdsBlue flex flex-col items-center justify-center pointer-events-auto px-4 pb-16'>
