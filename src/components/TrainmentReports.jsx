                                                                ...
                                                                <div className='sm:flex items-center justify-between w-full'>
                                                                    ...
                                                                    <div className='flex-col flex items-center justify-center gap-2 text-wrap'>
                                                                        <button
                                                                            ...
                                                                            className='bg-cdsBlue text-white w-full text-sm rounded-lg  p-2 hover:scale-102 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out cursor-pointer'
                                                                        >
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className='bg-cdsBlue w-full text-white text-sm rounded-lg  p-2 hover:scale-102 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out cursor-pointer'
                                                                        >
                                                                            Assistir ao vídeo
                                                                        </button>
                                                                    </div>
