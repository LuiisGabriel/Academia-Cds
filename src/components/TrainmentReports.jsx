                                    ...
                                    <div className="flex items-start w-full py-4 ">
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            <div className='w-full flex justify-end items-center'>
                                                <h1
                                                    className='font-bold hover:scale-115 transition-all duration-100 ease-in-out cursor-pointer'
                                                    onClick={() => {
                                                        closeDialog();
                                                    }}
                                                >X</h1>
                                                                ...
                                                                <div className='sm:flex items-center justify-between w-full'>
                                                                    ...
                                                                    <div className='flex-col flex items-center justify-center gap-2 text-wrap'>
                                                                        <button
                                                                            ...
                                                                            className='bg-gray-800 text-white w-full text-sm rounded-lg  p-2 hover:scale-102 hover:bg-gray-800/70 transition-all duration-300 ease-in-out cursor-pointer'
                                                                        >
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className='bg-gray-800 w-full text-white text-sm rounded-lg  p-2 hover:scale-102 hover:bg-gray-800/70 transition-all duration-300 ease-in-out cursor-pointer'
                                                                        >
                                                                            Assistir ao vídeo
                                                                        </button>
                                                                    </div>
                                                                    ...
                                                                    <div className='flex items-center justify-center gap-8'>
                                                                        ...
                                                                        <div className=''>
                                                                            ...
                                                                            <h1
                                                                                ...
                                                                                className='hover:scale-115 rotate-180 transition-all duration-100 ease-in-out cursor-pointer'
                                ...
                                >
                                    <div className='w-full flex items-center justify-end p-4'>
                                        <h1
                                            ...
                                            className='text-lg font-bold hover:scale-115 cursor-pointer'>
                                            X
                                        </h1>
                                    </div>
                                    <div className='p-8'>
                                ...
                                >
                                    <div className='w-full flex items-center justify-end p-4'>
                                        <h1
                                            ...
                                            className='text-lg font-bold hover:scale-115 transition-all duration-300 ease-in-out cursor-pointer'>
                                            X
                                        </h1>
                                    </div>
                                    <div className='px-8'>
