...
const Valuation = () => {
    ...
    const { ambiente, modulo, subModulo, valuationId, valuationTitle, valuationDescription } = location.state || { ambiente: '', modulo: '', subModulo: '', valuationId: false, valuationTitle: '', valuationDescription: '' };
    ...
    }, [valuationId, questions, ambiente, modulo, subModulo, filteredQuestions, navigate]);
                            ...
                            {filteredQuestions.map((question, questionIndex) => (
                                <div className='p-4' key={questionIndex}>
                                    <div className='p-8 bg-white rounded-lg '>
                                        ...
                                        <h1 className='text-lg px-4 py-8 w-full '>
                                            {question.title}
                                        </h1>
                                        ...
                                        {question.answerOptions.map((answerOption, answerIndex) => (
                                            <div className='flex items-center gap-4' key={answerIndex}>
                                                <input
                                                    ...
                                                    onClick={() => {
                                                        setDirty(true);
                                                        handleAnswerOptionClick(questionIndex, answerIndex);
                                                    }}
                                                />
