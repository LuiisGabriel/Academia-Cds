...
const Valuation = () => {
    ...
    const { ambiente, modulo, subModulo, valuationId, valuationTitle, valuationDescription, valuationQuestions } = location.state || { ambiente: '', modulo: '', subModulo: '', valuationId: '', valuationTitle: '', valuationDescription: '', valuationQuestions: [] };
    ...
    }, [valuationId, valuationQuestions, ambiente, modulo, subModulo, filteredQuestions]);
                    ...
                    <div className=' w-8/9 py-8'>
                        <form className='flex flex-col justify-start w-full select-none' id='form' >
                                    ...
                                    <div className='p-8 bg-white rounded-lg '>
                                        ...
                                        {question.answerOptions.map((answerOption, answerIndex) => (
                                            <div className='flex items-center gap-4' key={answerIndex}>
                                                <input
                                                    className="border-2 outline-none p-2 size-4 rounded-full cursor-pointer"
                            ...
                            <div className='flex justify-between items-center pt-4 px-4 w-3/3'>
                                <button
                                    className='bg-gray-800 rounded-lg p-2 text-white hover:bg-gray-700 hover:scale-102 shadow-lg/20 hover:shadow-lg/30 transition-all duration-300 ease-in-out cursor-pointer'
                                    onClick={() => {
