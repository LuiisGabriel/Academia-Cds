...
const Profile = () => {
  ...
  let isValidPassword = newPassword && confirmNewPassword && currentPassword && validatePasswordResult.length === 0 && confirmNewPassword.localeCompare(newPassword) === 0;
  let isConfirmPassword = confirmNewPassword.localeCompare(newPassword) === 0;
          ...
          <div className='w-full flex items-center justify-end py-8 gap-8'>
            {!isEditUser && (
              ...
              <img
                ...
                className='mr-4 size-5 hover:scale-115 transition-all duration-300 ease-in-out cursor-pointer'
                src={pencilEdit}
              />
            ...
            <div className='w-ful flex items-center justify-center'>
              <div className={`w-1/2 sm:w-1/4 flex items-center ${dirty ? 'justify-between' : 'justify-center'}`}>
                ...
                {dirty && (<button
                  ...
                  className='p-2 text-white rounded-lg bg-cdsBlue cursor-pointer hover:scale-105 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out'>
                  Salvar
                </button>)}
        ...
        <div className='p-16 w-full'>
          ...
          {user?.answeredValuations?.map((valuation) => (
            <div
              ...
              <div
                className="flex items-center justify-between p-4 gap-8 bg-cdsBlue rounded-lg w-full "
              >
            ...
            return concluedTrainments.length > 0 ? (
              concluedTrainments.map((treinamento) => (
                <div
                  ...
                  <div
                    className="flex items-center justify-between p-4 gap-8 bg-cdsBlue rounded-lg w-full mt-2"
                  >
                    <h1 className='font-semibold text-white'>
                      {treinamento.titulo}
                    </h1>
                ...
                <div className="flex min-h-screen justify-center text-center items-center">
                  ...
                  >
                    ...
                    <div className='w-full gap-2 flex flex-col items-center justify-start select-none'>
                      ...
                      <div className='flex flex-col items-center justify-center w-3/4'>
                        ...
                        <div className='py-2 w-full'>
                          ...
                          <input
                            ...
                            value={newPassword}
                            required
                            className={`p-2 rounded-lg border-2 ${validatePasswordResult.length > 0 && newPassword && 'border-red-500'} outline-none w-full`}
                        ...
                        {validatePasswordResult?.map((result, index) => (
                          <div
                            ...
                            {newPassword && (<div className='py-1'>
                        ...
                        <div className='py-2 w-full'>
                          ...
                          <input
                            ...
                            required
                            className={`p-2 rounded-lg border-2 ${!isConfirmPassword && confirmNewPassword && 'border-red-500'} outline-none w-full`}
                            placeholder='Confirme a nova senha'
                          />
                        </div>

                        {!isConfirmPassword && confirmNewPassword && (
                      ...
                      <div className={`flex items-center ${isValidPassword ? 'justify-between' : 'justify-center'}  w-1/2`}>
                        {isValidPassword && (
                          <div>
                            <button
                              onClick={() => {
                              ...
                              className='p-2 bg-cdsBlue text-white rounded-lg cursor-pointer hover:scale-105 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out'>
                              Salvar
                            </button>
                          </div>
                        )}
                    ...
                    <div className='w-full flex flex-col items-center justify-center'>
                      ...
                      <div className='w-full flex flex-col items-center justify-center'>
                        <div className='w-full flex flex-col gap-4'>
                          ...
                          <div className='w-full flex items-center justify-center'>
                            <h1>
                              Para excluir sua conta, reescreva a frase abaixo:
                            </h1>
                          </div>
                      ...
                      <div className={`sm:w-1/3 gap-8 flex items-center ${confirmationPhrase === userEmail ? 'justify-between' : 'justify-center'} pt-8`}>
                        ...
                        <button
                          ...
                          className='p-2 cursor-pointer rounded-lg bg-cdsBlue hover:scale-105 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out'>
                  ...
                  {sections.map((section, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full bg-(--color) text-(--text-color) flex items-center justify-center p-4 rounded-t-lg ${isActive ? 'pointer-events-none' : 'cursor-pointer'}`}>
                        <h1
                          style={{
