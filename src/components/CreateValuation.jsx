                                        ...
                                        <div className='flex flex-col justify-center items-center w-full gap-8'>
                                            ...
                                            <div
                                                ...
                                                {answerOptions.length >= 4 && (
                                                    <button
                                                        className="flex justify-center w-1/2 sm:w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-cdsBlue  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out"
                                                        onClick={() => {
                        ...
                        <div className=" w-3/4 h-3/4 shadow-lg rounded-md bg-white p-8 flex flex-col select-none">
                            ...
                            <div className="flex flex-1 flex-col justify-evenly gap-8">
                                ...
                                <div className='w-full flex items-center justify-center'>
                                    ...
                                    <button
                                        className="flex justify-center p-2 rounded-md self-center bg-cdsBlue text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out "
