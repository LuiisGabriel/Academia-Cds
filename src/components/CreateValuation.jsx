...
const CreateValuation = () => {
    ...
    const createAndPublishValuation = async () => {
        try {
            if (!titulo && !descricao && !ambiente && !modulo && !subModulo) {
                ...
                return;
            } else if (valuationQuestions.length < { questionsThreshold }) {
                alert('Cadastre pelo menos ' + { questionsThreshold } + ' questões!');
                return;
            }
            setIsLoading(true);
                            ...
                            <div className="flex flex-1 flex-col justify-evenly gap-8">
                                ...
                                <div className='w-full flex items-center justify-between'>
                                    <button
                                        ...
                                        onClick={createAndPublishValuation}
                                    >
                                        {
                                            isLoading ?
