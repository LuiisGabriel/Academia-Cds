...
import { Player, Youtube, Ui, ClickToPlay, DefaultControls } from '@vime/react';
...
const RetaguardaWebCadastros = () => {
    ...
    async function handleCondicao() {
        if (watchedVideos.length >= length) {
            setCondicao('apto');
        }
        else {
            setCondicao('inapto');
    ...
    const handleEnded = () => {
        ...
        if (isVideo) {
            ...
            setWatchedVideos(prev => ([
                ...prev,
                { id: videoId, ambiente: ambiente, modulo: modulo, subModulo: subModulo }
            ]),
            );
        }
    };
        ...
        <>
            ...
            <div className=' bg-gray-300 w-full h-auto h-full px-8 pb-16 gap-8 md:flex justify-center'>
                <div className="flex flex-col w-full ">
                    <div key={videoId}>
                        <Player onVmPlaybackEnded={handleEnded}>
                            <Youtube videoId={id} />
                            <Ui>
                                <ClickToPlay />
                ...
                <div className="flex flex-col items-center w-full py-8 md:py-0 md:w-1/4">
                    <div className='text-center text-xl lg:text-2xl font-bold tracking-tight pb-12'>
