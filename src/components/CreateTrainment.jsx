...
const CreateTrainment = () => {
    ...
    const [postCreateTrainment, setPostCreateTrainment] = useState(false);
    ...
    const publishTrainment = async () => {
        ...
        try {
            ...
            if (!publishResponse?.data) {
                ...
                setDirty(false);
                setPostCreateTrainment(false);
                alert('Treinamento publicado com sucesso!');
            }
        }
        catch (err) {
        ...
        <>
            ...
            <div className="w-full min-h-screen h-full bg-gray-300">
                ...
                <div className='flex justify-center items-center py-16'>
                    ...
                    <Dialog open={open} onClose={() => { }}
                        ...
                        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div className="flex min-h-screen justify-center text-center items-center">
                                <DialogPanel
                                    transition
                                    className="relative transform overflow-hidden rounded-lg bg-white px-8 py-6 text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in my-8 w-5/6 data-closed:sm:translate-y-0 data-closed:sm:scale-95">
                                    <div className='w-full flex items-center justify-end'>
                                        <h1
                                            onClick={() => { setOpen(false); }}
                                            className='text-lg font-bold hover:scale-105'>
                                            X
                                        </h1>
                                    </div>
                    ...
                    <Dialog open={postCreateTrainment} onClose={() => { }}
                        className="relative z-10 select-none">
                        <DialogBackdrop
                            transition
                            className="fixed inset-0 h-screen bg-black/60 transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in"/>
                                        ...
                                        <div className='sm:flex items-center justify-center sm:w-3/4 space-y-8 sm:space-y-0 gap-8 w-full'>
                                            <div className='flex items-center justify-center sm:justify-between min-w-1/4'>
                                                <button
                                                    onClick={() => {
                                                        publishTrainment();
                                                        navigate(APP_ROUTES.TRAINMENT_REPORTS);
                                                    }}
                                            ...
                                            <div className='flex items-center justify-center min-w-1/4'>
                                                <button
                                                    ...
                                                    className='bg-cdsBlue text-white p-2 rounded-lg shadow-lg/30 hover:scale-105 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out'>
                                                    Cadastrar outro
                                                </button>
                                            </div>
                                            <div className='flex items-center justify-center min-w-1/4'>
                    ...
                    <div className=" w-5/6 h-3/4 shadow-lg rounded-md bg-white p-8 flex flex-col select-none">
                        ...
                        <form
                            ...
                            <div className='w-full flex items-center justify-center'>
                                <button
                                    className="flex justify-center p-2 rounded-md w-1/3 self-center bg-cdsBlue text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out "
                                    type="submit">
                                    {
                                        isLoading ?
