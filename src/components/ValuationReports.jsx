                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            <div className='flex items-center justify-between pt-8'>
                                                {stage === 'PUBLISHED' ? (
                                                    ...
                                                    <button
                                                        className="flex justify-center w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-gray-800  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out"
                                                        onClick={() => {
                                ...
                                >
                                    <div className='w-full flex items-center justify-end py-4'>
                                        <h1
                                            ...
                                            className='text-xl font-bold hover:scale-115'>
                                            X
                                        </h1>
                                    </div>
