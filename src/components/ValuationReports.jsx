                                    ...
                                    <div className="flex items-start w-full py-4 ">
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            <div className='w-full flex justify-end items-center'>
                                                <h1
                                                    className='font-bold hover:scale-105 transition-all duration-100 ease-in-out cursor-pointer'
                                                    onClick={() => {
                                                        closeDialog();
                                                    }}
                                                >X</h1>
                                                ...
                                                {valuationQuestions?.map((question, index) => (
                                                    ...
                                                    >
                                                        <div className='px-2 w-full '>
                                                            <MenuButton className="cursor-pointer inline-flex w-full justify-between gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold ring-inset hover:bg-gray-50">
                                            ...
                                            {editValuationQuestions && (<div className='flex items-center justify-center pt-8'>
                                                <button
                                                    ...
                                                    className='rounded-lg bg-gray-800 p-2 text-white hover:scale-105 hover:bg-gray-800/70 cursor-pointer'>
                                                    Salvar
                                                </button>
                                            </div>)}
                                            ...
                                            <div className='flex items-center justify-between pt-8'>
                                                {stage === 'PUBLISHED' ? (
                                                    <button
                                                        className="flex justify-center w-1/2 sm:w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-gray-800  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
                                                        onClick={() => {
                                                    ...
                                                    <button
                                                        className="flex justify-center w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-gray-800  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
                                                        onClick={() => {
                                                ...
                                                <button className='text-red-500 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer'
                                                    onClick={() => {
                    ...
                    <Dialog open={isAddQuestion} onClose={() => { }}
                        ...
                        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div className="flex min-h-screen justify-center text-center items-center">
                                <DialogPanel
                                    transition
                                    className="relative transform overflow-hidden rounded-lg bg-white px-8 text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in my-8 w-5/6 data-closed:sm:translate-y-0 data-closed:sm:scale-95"
                                >
                                    <div className='w-full flex items-center justify-end py-4'>
                                        <h1
                                            ...
                                            className='text-xl font-bold hover:scale-115 cursor-pointer'>
                                            X
                                        </h1>
                                    </div>
                                    <div className='flex flex-col justify-center items-center w-full gap-8 pb-8'>
                                        <div className='flex flex-col justify-center items-center w-full gap-8'>
                                            ...
                                            <div className='w-full flex flex-col items-center justify-center gap-8'>
                                                ...
                                                <button
                                                    className="flex justify-center p-2 rounded-md w-1/2 self-center bg-gray-800  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
                                        ...
                                        <div className='flex flex-col justify-center items-center gap-2 w-full text-center'>
                                            ...
                                            {answerOptions?.map((answerOption, index) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        className='text-2xl hover:scale-115 transition-all duration-300 ease-in-out cursor-pointer' 
                                                        onClick={() => {
                        ...
                        <div className='flex flex-col justify-start w-full gap-8' id='form' >
                            {valuations.map((valuation) => (
                                <div
                                    ...
                                    className='p-8 bg-white flex flex-col justify-center rounded-lg hover:scale-102 hover:shadow-lg/20 transition-all duration-300 ease-in-out cursor-pointer'>
