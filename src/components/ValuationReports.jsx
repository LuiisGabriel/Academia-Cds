                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            {editValuationQuestions && (<div className='flex items-center justify-center pt-8'>
                                                <button
                                                    ...
                                                    className='rounded-lg bg-cdsBlue p-2 text-white hover:scale-105 hover:bg-cdsBlue/70 cursor-pointer'>
                                                    Salvar
                                                </button>
                                            </div>)}
                                            ...
                                            <div className='flex items-center justify-between pt-8'>
                                                {stage === 'PUBLISHED' ? (
                                                    <button
                                                        className="flex justify-center w-1/2 sm:w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-cdsBlue  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
                                                        onClick={() => {
                                                    ...
                                                    <button
                                                        className="flex justify-center w-auto text-xs sm:text-base p-2 rounded-md  self-center bg-cdsBlue  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
                                                        onClick={() => {
                                    ...
                                    <div className='flex flex-col justify-center items-center w-full gap-8 pb-8'>
                                        <div className='flex flex-col justify-center items-center w-full gap-8'>
                                            ...
                                            <div className='w-full flex flex-col items-center justify-center gap-8'>
                                                ...
                                                <button
                                                    className="flex justify-center p-2 rounded-md w-1/2 self-center bg-cdsBlue  text-white hover:bg-gray-700 hover:scale-102 transition-all duration-300 ease-in-out cursor-pointer"
