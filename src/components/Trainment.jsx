...
const Trainment = () => {
    ...
    useEffect(() => {
        if (currentVideo > -1) {
            ...
            setVideoTitulo(videos[currentVideo].titulo);
            setVideoUrl(videos[currentVideo].url);
            setVideoDescricao(videos[currentVideo].description);
        }
    }, [currentVideo])
                            ...
                            <div className="flex-col flex w-full gap-4">
                                {videos?.map((video, index) => (
                                    <button
                                        ...
                                        className="bg-(--color) flex items-center p-2 justify-center rounded-md h-30 hover:bg-gray-700"
                                        onClick={() => {
