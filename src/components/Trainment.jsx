            ...
            <div className="bg-gray-300 h-auto h-full min-h-screen">
                ...
                <div className=' px-8 py-8 justify-center'>
                    ...
                    <div className='md:flex gap-8'>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    {user.role == 'ADMIN' && (
                                        <button
                                            ...
                                            className='bg-gray-800 text-white rounded-lg p-2 hover:scale-102 hover:bg-gray-800/70 transition-all duration-300 ease-in-out cursor-pointer'
                                        >
                        ...
                        <div className="flex flex-col items-center w-full py-8 px-4 md:py-0 md:w-2/5 overflow-y-auto max-h-160">
                            <div className="flex-col flex w-full gap-4">
                                {videos?.map((video, index) => (
                                    <button
                                        style={{
                                            '--color': video.videoId === videoId || user.watchedVideos.filter(watchedVideo => watchedVideo.videoId === video.videoId).map(watchedVideo => watchedVideo.videoId).includes(video.videoId) ? "#475569" : "#1e293b",
                                        }}
                                        className="bg-(--color) flex items-center p-4 min-h-20 justify-center rounded-md hover:bg-gray-800/70 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer"
                                        onClick={() => {
