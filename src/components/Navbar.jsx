...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className='bg-(--color) select-none drop-shadow-lg/30'
      style={{
        ...
        <div className="relative flex h-16  items-center justify-between ">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 ">
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className=" transition-all duration-300 ease-in-out relative flex rounded-full bg-gray-800 text-sm hover:scale-105 focus:ring-offset-gray-800 focus:outline-hidden cursor-pointer">
