                                    ...
                                    <div className="flex items-start w-full py-4 ">
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            <div className='flex justify-between items-center gap-2 pb-4 select-text'>
                                                ...
                                                {!isEditUser && (<div>
                                                    <img
                                                        className='size-5 hover:scale-115 transition-all duration-300 ease-in-out select-none cursor-pointer'
                                                        src={pencilEdit}
                                                        onClick={() => {
                                                            setIsEditUser(true);
                                                        }}
                                            ...
                                            {isEditUser ? (
                                                <div className='w-full max-h-15 py-4 gap-2 flex items-center justify-start select-none'>
                                                    ...
                                                    <select
                                                        ...
                                                        value={userRole}
                                                        className="border-2 outline-none rounded-md font-semibold cursor-pointer"
                                                    >
                                                        <option value='USER'>
                                                            Usuário
                                                        </option>
                                                ...
                                                <div className='w-full gap-2 sm:flex items-center justify-start select-none'>
                                                    ...
                                                    <div>
                                                        <button
                                                            ...
                                                            className='p-2 text-red-500 hover:scale-105 cursor-pointer'>
                                                            Cancelar
                                                        </button>
                                                    </div>
                                                </div>
                                                    ...
                                                    {isEditUser && (
                                                        <div>
                                                            <button
                                                                ...
                                                                className='bg-gray-800 p-2 rounded-lg text-white text-sm hover:scale-105 hover:bg-gray-800/70 tyransition-all duration-300 ease-in-out cursor-pointer'>
                                                                Redefinir senha
                                                            </button>
                                                        </div>
                                                    )}
                                                        ...
                                                        {userAnsweredValuations?.map((valuation, index) => (
                                                            <Menu
                                                                ...
                                                                <div className='px-2 w-full'>
                                                                    <MenuButton
                                                                        className="cursor-pointer inline-flex w-full justify-between gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold ring-inset hover:bg-gray-50">
                                            ...
                                            {isEditUser ? (
                                                <div className='flex items-center justify-center p-2 select-none'>
                                                    <button
                                                        ...
                                                        className='p-2 text-white rounded-lg bg-gray-800 hover:scale-105 hover:bg-gray-800/70 transition-all duration-300 ease-in-out cursor-pointer'>
                                                        Salvar
                                                    </button>
                                                </div>
                                            ) : (
                        ...
                        <div className='flex flex-col justify-start w-full' id='form' >
                            {users.map((userMap, index) => (
                                <div
                                    ...
                                    className='p-4'
                                    key={index}>
                                    <div className='p-8 bg-white flex justify-between rounded-lg hover:scale-102 hover:shadow-lg/20 transition-all duration-300 ease-in-out cursor-pointer'>
                                        <div>
