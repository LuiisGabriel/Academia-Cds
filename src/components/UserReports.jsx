...
const UserReports = () => {
    ...
    const redefineUserPassword = async () => {
    ...
    const closeRedefinePassword = () => {
        if (!dirty) {
            setIsRedefinePassword(false);
        } else {
            if (confirm('Você tem mudanças não salvas deseja descarta-las?')) {
                setIsRedefinePassword(false);
                setIsDirty(false);
            } else {
                                    ...
                                    <div className="flex items-start w-full py-4 ">
                                        <div className="mt-3 text-center sm:mt-0 sm:text-left px-6 w-full">
                                            ...
                                            {isEditUser && (
                                                <div className='flex flex-col items-center justify-center'>
                                                    <button
                                                        ...
                                                        className='p-2 bg-gray-800 text-white rounded-lg hover:scale-105 hover:bg-gray-800/70 transition-all duration-300 ease-in-out'>
                                                        Redefinir senha
                                                    </button>
                                                </div>
                                            )}
                                            <h1 className='pt-8 select-none'>
                                            ...
                                            <div className='py-4 overflow-y-auto max-h-100 select-none'>
                                                ...
                                                ) : <div className='p-4 font-semibold'>Este usuário ainda não respondeu nenhuma avaliação</div>}
                                            </div>
                                            ...
                                            <div className='py-4 space-y-4 overflow-y-auto max-h-100 select-none'>
                                                {(() => {
                                                    ...
                                                    return concluedTrainments.length > 0 ? (
                                                        ...
                                                        <div className='p-4 font-semibold'>Este usuário ainda não concluiu nenhum treinamento</div>
                                                    );
                                                })()}
                                            </div>
                                            ...
                                            {isEditUser ? (
                                                <div className='flex items-center justify-center p-2 select-none'>
                                                    <button
                                                        ...
                                                        className='p-2 text-white rounded-lg bg-gray-800 hover:scale-105'>
                                                        Salvar
                                                    </button>
                                                </div>
                                            ) : (
                    ...
                    <Dialog open={isRedefinePassword} onClose={() => { }}
                        ...
                        <div className="fixed inset-0 z-10 w-screen overflow-y-auto ">
                            <div className="flex min-h-screen justify-center text-center items-center">
                                <DialogPanel
                                    transition
                                    className="relative transform overflow-hidden rounded-lg bg-white px-8 py-4 w-7/8 text-left shadow-xl transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in my-8 data-closed:sm:translate-y-0 data-closed:sm:scale-95"
                                >
                                    <div className='w-full flex items-center justify-end'>
                                        <button
                                            onClick={() => {
                                                closeRedefinePassword();
                                            }}
                                            className='text-lg font-bold pb-4 hover:scale-115 transition-all duration-300 ease-in-out'>
                                            X
                                        </button>
                                    </div>
                                    <div className='w-full flex items-center justify-center pb-8'>
                                        <h1 className='text-2xl font-semibold'>
                                            Redefina a senha deste usuário
                                        </h1>
                                    </div>
                                    <form
                                        onSubmit={redefineUserPassword}
                                        ...
                                        <input
                                            ...
                                            value={newPassword}
                                            required
                                            className='w-3/4 p-2 rounded-lg border-2 outline-none'
                                        ...
                                        <button
                                            type='submit'
                                            className='w-1/4 p-2 bg-gray-800 text-white rounded-lg hover:scale-105 hover:bg-gray-800/70 transition-all duration-300 ease-in-out'>
                                            Redefinir senha
                                        </button>
                                    </form>
                                </DialogPanel>
