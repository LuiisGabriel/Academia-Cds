                                                    ...
                                                    {isEditUser && (
                                                        <div>
                                                            <button
                                                                ...
                                                                className='bg-cdsBlue p-2 rounded-lg text-white text-sm hover:scale-105 hover:bg-cdsBlue/70 tyransition-all duration-300 ease-in-out cursor-pointer'>
                                                                Redefinir senha
                                                            </button>
                                                        </div>
                                                    )}
                                            ...
                                            {isEditUser ? (
                                                <div className='flex items-center justify-center p-2 select-none'>
                                                    <button
                                                        ...
                                                        className='p-2 text-white rounded-lg bg-cdsBlue hover:scale-105 hover:bg-cdsBlue/70 transition-all duration-300 ease-in-out cursor-pointer'>
                                                        Salvar
                                                    </button>
                                                </div>
                                            ) : (
